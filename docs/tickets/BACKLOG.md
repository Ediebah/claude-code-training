...
## NWP-1094 · Edit a card's spend limit after issue
...
Referenced as out of scope by [NWP-1088](NWP-1088.md).

## NWP-1103 · Persist console data
...
Referenced as out of scope by [NWP-1088](NWP-1088.md). **Do not build this during a workshop exercise.**

## NWP-1110 · Webhook delivery log
...
## NWP-1121 · Reconciliation view

**Type** Story · **Status** Backlog · **Priority** Medium

A screen that compares a payout's recorded net against the sum of its line items and shows the delta. Would have caught [NWP-1057](NWP-1057.md) before a merchant did.
